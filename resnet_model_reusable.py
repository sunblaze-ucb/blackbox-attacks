...
class ResNet(object):
  ...
  def _batch_norm(self, name, x):
    ...
    with tf.variable_scope(name):
      ...
      # Always call assign_moving_average to create shadow variables.
      # In evaluation mode, we just never run the step.
      mean, variance = tf.nn.moments(x, [0, 1, 2], name='moments')
      assign_mean = moving_averages.assign_moving_average(
          moving_mean, mean, 0.9)
      assign_variance = moving_averages.assign_moving_average(
