...
# usage: python generate_test_optq.py <destination> <ckpt_dir> <epsilon> <offset>
...
opt = opt_li.CarliniLi(sess, m, targeted=False, learning_rate=5e-2, max_iterations=100, eps=epsilon, random_init=True)
first_net.load(sess)
